...
if (window.location.href.includes("register?") === true) {
  window.onload  = function() {
    ...
    document.getElementById('ui-id-1').innerHTML=   "<div style = 'font-size:14px'> <img src= 'https://instructure-uploads.s3.amazonaws.com/account_158170000000000001/attachments/3326/{Insert Organization Name}_logo_tangerine_ff4f35.png' width='200px' margin-left='auto' margin-right='auto'><br> <strong> <p> Thank you for completing your Welcome Survey! As a next step, let's create your account for {Insert Organization Name} Canvas. Canvas will be where you will engage in all your {Insert Organization Name} content, so make sure to choose a password that you will remember! If you already have a canvas account, you can login to your new course <u> <a  href = '"+ already_have_account  + "' target='_blank'> here.</a> </u> </strong> </p> <div>";  // quick message to welcome student to {Insert Organization Name}, and instructions for filling out the form
